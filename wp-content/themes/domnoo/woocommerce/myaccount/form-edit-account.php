...
<form action="" method="post">
	...
	<p class="form-group form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'domnoo' ); ?> <span class="required">*</span></label>
	...
	<p class="form-group form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'domnoo' ); ?> <span class="required">*</span></label>
	...
	<p class="form-group form-row form-row-wide">
		<label for="account_email"><?php esc_html_e( 'Email address', 'domnoo' ); ?> <span class="required">*</span></label>
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password Change', 'domnoo' ); ?></legend>
		<p class="form-group form-row form-row-thirds">
			<label for="password_current"><?php esc_html_e( 'Current Password (leave blank to leave unchanged)', 'domnoo' ); ?></label>
			<input type="password" class="input-text form-control" name="password_current" id="password_current" />
		</p>
		<p class="form-group form-row form-row-thirds">
			<label for="password_1"><?php esc_html_e( 'New Password (leave blank to leave unchanged)', 'domnoo' ); ?></label>
			<input type="password" class="input-text form-control" name="password_1" id="password_1" />
		</p>
		<p class="form-group form-row form-row-thirds">
			<label for="password_2"><?php esc_html_e( 'Confirm New Password', 'domnoo' ); ?></label>
	...
	<p class="form-group">
		...
		<input type="submit" class="button" name="save_account_details" value="<?php esc_html_e( 'Save changes', 'domnoo' ); ?>" />

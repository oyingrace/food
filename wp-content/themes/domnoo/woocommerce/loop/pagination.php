...
$pagination_type = domnoo_get_config('product_pagination', 'default');
...
?>
	<div class="ajax-pagination <?php echo trim($pagination_type == 'loadmore' ? 'loadmore-action' : 'infinite-action'); ?>">
		...
		<a href="#" class="apus-loadmore-btn"><?php esc_html_e( 'Load More', 'domnoo' ); ?></a>
		<a href="#" class="apus-allproducts"><?php esc_html_e( 'All products loaded.', 'domnoo' ); ?></a>
	</div>
<?php
} else {

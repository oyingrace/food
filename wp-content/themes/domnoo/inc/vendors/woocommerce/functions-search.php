...
if ( !function_exists( 'domnoo_autocomplete_search' ) ) {
    function domnoo_autocomplete_search() {
        if ( domnoo_get_config('enable_autocompleate_search', true) ) {
            ...
            add_action( 'wp_ajax_domnoo_autocomplete_search', 'domnoo_autocomplete_suggestions' );
            add_action( 'wp_ajax_nopriv_domnoo_autocomplete_search', 'domnoo_autocomplete_suggestions' );
        }
    }
}
add_action( 'init', 'domnoo_autocomplete_search' );

if ( !function_exists( 'domnoo_autocomplete_suggestions' ) ) {
    function domnoo_autocomplete_suggestions() {
